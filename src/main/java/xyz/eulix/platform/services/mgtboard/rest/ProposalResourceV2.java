...
@ApplicationScoped
@Path("/v2/service")
@Tag(name = "Platform Proposal Management Service", description = "意见反馈APIv2")
public class ProposalResourceV2 {
    ...
    public void proposalDel(@NotBlank @Parameter(required = true) @HeaderParam("Request-Id") String requestId,
