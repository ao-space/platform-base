...
public enum NotificationEnum {
    BOX_UPGRADE("系统升级", "发现新的傲空间系统版本，点击查看", "系统升级推送", "box_upgrade", AfterOpenAction.GO_APP),
    APP_UPGRADE("应用升级", "发现新的傲空间应用版本，点击查看", "应用升级推送", "app_upgrade", AfterOpenAction.GO_APP),
    ;
