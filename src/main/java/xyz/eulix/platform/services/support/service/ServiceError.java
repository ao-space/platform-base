...
public enum ServiceError {
  ...
  APPLET_VERSION_NOT_LATEST(2038, "applet version is not latest."),
  BOX_VERSION_TOO_OLD(2039, "box version is too old and incompatiable"),
  APPLET_NOT_EXIST(2040, "applet does not exist"),
