CREATE TABLE IF NOT EXISTS pkg_info (
    ...
    min_compatible_android_version VARCHAR(128) NOT NULL COMMENT '最小android兼容版本',
    min_compatible_ios_version VARCHAR(128) NOT NULL COMMENT '最小ios兼容版本',
    min_compatible_box_version VARCHAR(128) NOT NULL COMMENT '最小box兼容版本',
